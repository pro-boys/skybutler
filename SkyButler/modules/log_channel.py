...
if is_module_loaded(FILENAME):
    ...
    from SkyButler.modules.sql import log_channel_sql as sql
    ...
    def logging(bot: Bot, update: Update):
        ...
        if log_channel:
            ...
            message.reply_text(
                sbt(chat_id, "This group has all it's logs sent to: {} (`{}`)").format(escape_markdown(log_channel_info.title),
                                                                         log_channel),
                parse_mode=ParseMode.MARKDOWN)

        else:
            message.reply_text(sbt(chat_id, "No log channel has been set for this group!"))
    ...
    def setlog(bot: Bot, update: Update):
        ...
        if chat.type == chat.CHANNEL:
            ...
            bot.send_message(chat.id, sbt(chat_id, "Successfully set log channel!"))
    ...
    def __chat_settings__(chat_id, user_id):
        ...
        if log_channel:
            ...
            return sbt(chat_id, "This group has all it's logs sent to: {} (`{}`)").format(escape_markdown(log_channel_info.title),
                                                                            log_channel)
        return sbt(chat_id, "No log channel is set for this group!")
