...
from SkyButler.modules.disable import DisableAbleRegexHandler
...
def sed(bot: Bot, update: Update):
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        if not repl:
            update.effective_message.reply_to_message.reply_text(sbt(chat_id, "You're trying to replace... "
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(sbt(chat_id, "Hey everyone, {} is trying to make "
            ...
            update.effective_message.reply_text(sbt(chat_id, "Do you even sed? Apparently not."))
            return

        # empty string errors -_-
        if len(text) >= telegram.MAX_MESSAGE_LENGTH:
            update.effective_message.reply_text(sbt(chat_id, "The result of the sed command was too long for \
                                                 telegram!"))
        elif text:
